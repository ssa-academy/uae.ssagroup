            ...
            while($servicepageOrganisations->have_posts()) {
                $servicepageOrganisations->the_post(); ?>
                    <div class="bg-customWhite md:mx-4 mx-2">
                        ...
                        <div class="w-full md:h-[500px] min-h-96 text-customWhite p-5 bg-cover flex flex-col justify-end transition-transform duration-500 ease-in-out transform hover:scale-110" 
                        style="background:linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.8) 100%), url('<?php the_post_thumbnail_url(); ?>'); background-size: cover; background-position: center;">
                            ...
                            <p class="text-[14px] font-[700] leading-[24px] text-justify max-h-12 text-ellipsis line-clamp-2 mb-4"><?php if (has_excerpt()) {
