...
<section class="min-h-max bg-customDark py-20">
    <div class="container px-5 <?= $article_1st->have_posts() ? 'hidden' : 'grid justify-center items-center' ?>">
    ...
    <div class="container px-5 pb-10 text-customWhite space-y-5 mb-10 lg:mb-0 <?= $article_1st->have_posts() ? '' : 'hidden' ?>">
    ...
    <div class="container px-5">
        <div class="grid lg:grid-cols-5 lg:gap-20 gap-16">
            ...
            <div class="grid gap-5 lg:col-span-3" data-aos="fade-down-left">
                <?php if ($article_1st->have_posts()) : ?>
                    ...
                    <a href="<?php the_permalink(); ?>">
                        <h2 class="text-xl font-bold font-poppins text-customWhite"><?php the_title(); ?></h2>
                        <div class="text-sm mt-5 text-customWhite line-clamp-2 text-ellipsis overflow-hidden"><?php the_content(); ?></div>
                    </a>
                <?php endif; ?>
            ...
            <div class="grid lg:col-span-2 lg:gap-5" data-aos="fade-down-left" data-aos-delay="200">
                ...
                ?>
                    <?php while ($article_next_three->have_posts()) : $article_next_three->the_post(); ?>
                        <a class="border-b border-customWhite" href="<?php the_permalink(); ?>">
                            <div class=" flex py-5 gap-5 lg:py-0">
                                ...
                                <div class="flex flex-col gap-5">
                                    <p class="text-sm text-customGray2 italic"><?php the_time('F j, Y') ?></p>
                                    <h2 class="text-[20px] font-bold leading-[26px] font-poppins text-customWhite line-clamp-3 overflow-hidden text-ellipsis"><?php the_title(); ?></h2>
                                </div>
                            </div>
                        </a>
                    <?php endwhile; ?>
