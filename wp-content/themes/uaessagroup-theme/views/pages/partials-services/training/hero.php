<section class="min-h-max bg-center bg-cover bg-fixed bg-hero-pattern">\
    <div class="container xl:max-w-screen-2xl text-customWhite lg:text-center mx-auto py-32 block">
        <div class="container mx-auto px-5 lg:max-w-[784px] lg:px-0 space-y-5">
            ...
            <p class="text-sm">SSA Group provides a variety of training courses to assist employees reach their full potential and connect people with possibilities throughout your organization. Tap into your employees and assist them in finding opportunities that match their unique skills, experiences, and goals. </p>
        </div>
    </div>
</section>